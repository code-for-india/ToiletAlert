                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="box box-warning">
                                ...
                                <div class="box-body">
                                    <!-- form start -->
                                <form role="form" action="upload_products_csv.php" method="post" enctype="multipart/form-data">
                                    <div class="box-body">
                                         <div class="form-group">
                                            <label for="exampleInputFile">CSV File input</label>
                                            <input type="file" name="file" id="file" accept=".csv">
                                            <br/>
                                            <p class="help-block">Please Upload the CSV in format provided by developer</p>
                                        </div>
