...
<html>
    <head>
        <meta charset="UTF-8">
        <title>eBoookMyEvent.com | Add new food subheaders</title>
   ...
   include_once($path); ?>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Settings
                        <small>Add Food - Select Hotel</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="#">Settings</a></li>
                        <li class="active">Add Food - Select Hotel</li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="box box-warning">
                                <div class="box-header">
                                    <h3 class="box-title">Add food hotel selection</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">
                                    <form role="form" method="post" action="add-food-headers.php">
                                        <!-- text input -->
                                        <!-- select -->
