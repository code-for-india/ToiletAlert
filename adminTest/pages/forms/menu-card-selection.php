...
$menucard_id=$_GET['menucard_id'];
?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
        <title>eBoookMyEvent.com | Menu Card Selection</title>
   ...
   include_once($path); ?>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Settings
                        <small>Menu Card Selection</small>
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="#">Settings</a></li>
                        <li class="active">Menu Card Selection</li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="box box-warning">
                                <div class="box-header">
									...
									$qq1=mysql_query("SELECT * FROM hotels WHERE id LIKE '$hotel_id'");
									while($rr1=mysql_fetch_array($qq1))
									{
										echo $rr1['name'];
									}
									
									$qq1=mysql_query("SELECT * FROM menu_cards WHERE id LIKE '$menucard_id'");
									while($rr1=mysql_fetch_array($qq1))
									{
										echo " (".$rr1['menu_name'].")";
									}
                                ...
                                <div class="box-body">
                                    <form role="form" method="post" action="processing/menu-card-selection.php">

										<div class="form-group">
                                            <label>Food Header</label>
                                            <select class="form-control" name="food_header">
                                            <?php 
										$c=1;
										$query=mysql_query("SELECT * FROM food_headers WHERE hotel_id LIKE '$hotel_id' ORDER BY name");
                                        ...
                                        <div class="form-group">
                                            <label>Select any (numeric)</label>
                                            <input type="text" name="select_any" class="form-control" placeholder="4" required/>
                                            <input type="hidden" value="<?php echo $hotel_id ?>" name="hotel_id">
                                            <input type="hidden" value="<?php echo $menucard_id ?>" name="menucard_id">
                                        </div>
