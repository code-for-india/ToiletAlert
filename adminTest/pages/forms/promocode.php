                ...
                <section class="content">
                    <div class="row">
                                ...
                                <div class="box-body">
                                    <form role="form" method="post" action="processing/add-promo-code.php">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="promocode" class="form-control" placeholder="Promo Code Name" required/>
                                        </div>
                                         <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="box box-warning">
                                <div class="box-header">
                                    <h3 class="box-title">Current Promos</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">
