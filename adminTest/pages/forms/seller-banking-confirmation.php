...
if($_POST){
    ...
    {
    	$result = mysql_query("update seller_banking set status='Rejected' where id=$id");
    }
    function accept_user($id)
    {
    	$result = mysql_query("update seller_banking set status='Accepted' where id=$id");
...
?>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        Admin Workspace
                        <small>Confirm Seller Bank Account</small>
                    </h1>
                    <ol class="breadcrumb">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-warning">
                                <div class="box-header">
                                    <h3 class="box-title">Seller Banking Confirmation</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body">
                                    <table class="table table-bordered">
                                        ...
                                        <?php 
										$c=1;
										$qlocation=mysql_query("SELECT * FROM seller_banking where status='Pending'");
										while($rlocation=mysql_fetch_array($qlocation))
										{
										?>
                                        <tr>
                                            <td><?php echo $c; $c=$c+1; ?></td>
                                            <td><?php echo $rlocation['acc_name']; ?></td>
                                             <td><?php echo $rlocation['acc_number']; ?></td>
                                            <td>
                                                <?php echo $rlocation['bank_name']; ?>
                                            </td>
 															<td>
                                                <?php echo $rlocation['ifsc_code']; ?>
                                            </td>
<td>
