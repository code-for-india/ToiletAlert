...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Admin panel | Data view | Hotels Venues</title>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php 
												...
												?>
												<tr>
                                                	<td><a href="../forms/edit-hotels-venues.php?hvid=<?php echo $rv['id']; ?>"><?php echo $c; $c=$c+1; ?></a></td>
													<td><?php $rvid=$rv['hotel_id'];
													$qh=mysql_query("SELECT * FROM hotels WHERE id LIKE '$rvid'");
														while($rh=mysql_fetch_array($qh))
														{
															echo $hotelname=$rh['name'];
															$hoteladdress=$rh['address'];
														}
														?>
													</td>
